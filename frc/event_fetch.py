#==================================================================================================
# This script retrieves information about a specific event for a specific year and saves the JSON
# results to file.
#==================================================================================================
import datetime
import json
...
def retrieveEventFromFirst(firstEventKey):
    status(f"Retrieving Event {firstEventKey} from FIRST...")
    ...
    status(f"Fetched Event: '{firstEvent["name"]}'")  
...
def retrieveMatchesFromFirst(firstEventKey):
    ...
    status(f"Retrieving Matches from FIRST: {len(firstMatches)} Matches returned")
...
def retrieveTeamsFromFirst(firstEventKey):
    ...
    status(f"Retrieving Teams from FIRST: {len(firstTeams)} Teams returned")
...
def retrieveResultsFromFirst(firstEventKey):
    ...
    status(f"Retrieving Results from FIRST: {len(matchResults)} Results returned")
