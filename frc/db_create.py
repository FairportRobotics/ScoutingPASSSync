...
filePath = os.path.join(rootPath, f"{firstEventYear}.db")
...
def frc_teams_create():
    ...
    CREATE TABLE frc_teams (
        ...
        nameShort TEXT COLLATE NOCASE NULL,
        nameFull TEXT COLLATE NOCASE NULL,
        city TEXT COLLATE NOCASE NULL,
        stateProv TEXT COLLATE NOCASE NULL,
        country TEXT COLLATE NOCASE NULL,
        rookieYear INTEGER,
